...
static const float sensor_calibrate_f = 0.29;
static const float sensor_calibrate_r = 0.29;

static const float encode_calibrate_l = -0.0154; // smaller = bigger turns
static const float encode_calibrate_r = 0.0154;

static const float motor_compensation_left = 1.00;  // When motor goes in one direction, it tends to go faster than the other
static const float motor_compensation_right = 1.00;
...
static const int forward_speed = 128/2;
static const int turn_leadin_speed = 64/2;
static const int turn_speed = 32/2;
static const int turn_leadout_speed = 64/2;
static const int turn_180_speed = 64/2;
